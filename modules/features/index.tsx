      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          {features?.slice(0, 3).map((feature, index) => (
            <FeatureCard key={`top-${feature.title}`} feature={feature} index={index} />
          ))}
        </div>
      ...
      <div className="h-full glass rounded-2xl p-8 border border-card-border hover:border-primary/30 transition-all duration-300 shadow-glow-subtle hover:shadow-glow-primary">
        ...
        <div className="mt-6 pt-6 border-t border-card-border">
          <div className="flex items-center space-x-2 text-sm text-primary">
            ...
            <span style={{ fontFamily: 'var(--font-main)', fontWeight: 700, color: 'var(--color-primary)', fontSize: '1.1rem', letterSpacing: '0.02em' }}>
              Memento Ai Powered
            </span>
          </div>
        </div>
